document.addEventListener('DOMContentLoaded', () => {
    const contentElements = document.querySelectorAll('.mel');
    const nextButton = document.getElementById('next');
    const backButton = document.getElementById('back');
    const melElement = document.getElementById('cr');
    ...
    if (storedValue) {
        melElement.textContent = storedValue;
    }
});